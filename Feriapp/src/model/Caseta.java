...
public class Caseta {
	...
	public String toString() {
		return "Caseta [numeroCaseta=" + numeroCaseta + ", nombreCaseta=" + nombreCaseta + ", nombreCalle="
				+ nombreCalle + ", aforoMaximo=" + aforoMaximo + ", aforoActual=" + aforoActual + ", horario=" + horario
				+ ", tipoCaseta=" + tipoCaseta + ", idPropietario=" + idPropietario + "]";
	}
